...
// WebRenderer.swift
// Responsible for generating HTML content for the web server.
// This keeps the HTML logic separate from the routing logic in main.swift.
// It generates server-side rendered (SSR) HTML strings.
